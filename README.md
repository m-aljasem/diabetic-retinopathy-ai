...
print(f"Severity Level: {result['prediction']}")
print(f"Confidence: {result['confidence']:.2%}")
print(f"All severity probabilities: {result['probabilities']}")
...
```json
{
  "mcpServers": {
    "retina": {
      "command": "python",
      "args": ["/home/m-aljasem/projects/ai-projects/retina/mcp_server.py"],
      "env": {
        "PYTHONPATH": "/home/m-aljasem/projects/ai-projects/retina"
      }
    }
  }
}
