"""
MCP Server for Diabetic Retinopathy Detection
...
app = Server("retina-mcp-server")

# Paths
MODELS_DIR = Path("models")
MODEL_PATH = MODELS_DIR / "retinopathy_model.h5"
...
async def list_tools() -> List[Tool]:
    ...
    return [
        Tool(
            name="predict",
            description="Make a prediction using the Diabetic Retinopathy Detection model. Input should be a file path to an image or base64 encoded image.",
            inputSchema={
                "type": "object",
                "properties": {
                    "input": {
                        "type": "string",
                        "description": "File path to image or base64 encoded image data"
                    }
                },
                "required": ["input"]
            }
